# -*- coding: utf-8 -*-
"""
Created on Mon May  6 23:38:49 2024

@author: jbunn
"""
#Final Project Radar Code
#The files used are from the station in Paducah, Kentucky

#First set of code shows the morning of the event
...
f = Level2File('KPAH20211210_061838_V06')
...
#Second set of code is the exact same as the first but it is from right as the system moved through
import cartopy.crs as ccrs
import matplotlib.gridspec as gridspec
import matplotlib.pyplot as plt
import numpy as np
...
f = Level2File('KPAH20211211_030505_V06')
